      ...
      <main>
        ...
        <section className="flex flex-col justify-center items-center w-full h-[60vh] p-4">
          ...
          <p className="text-center my-11 text-sm md:text-lg lg:text-xl">
            I recently got my bachelor's degree in <span className="text-[#e84606]">design</span> from Tehran University
            of Art.
            <br /> I enjoy designing user-centric products inspired by fine
            arts.
            <br /> I am also interested in designing products to help people
            with illnesses or natural disasters.
          </p>
        </section>
        <Footer />
      </main>
